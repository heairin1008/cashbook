...
<script>
	$(document).ready(function(){
		$('#addBtn').click(function(){
			//alert('test');
			let html = '<div><input id="inputFile" type="file" name="noticefile" class="noticefile"></div>';
...
<body>
	...
	<div id="table">
		...
		<form class="form-group" method="post" action="/admin/addNewNotice" enctype="multipart/form-data">
			<table id="table" class="table text-center">
				...
				<tr>
					<td colspan="2" class="text-right"><button id="submitBtn" class="btn btn-success" type="submit">등록</button></td>
				</tr>
			</table>
		</form>
	</div>

...
<link href="https://fonts.googleapis.com/css2?family=Kalam&family=Montserrat:wght@300&display=swap" rel="stylesheet">
...
<body>
	...
	<div class="table-bordered" id="total">
		<div style="margin-top:3%;"></div>
		<h1 class="text-center" id="logo">Login</h1>
		<div id="login" class="form-group">
		<form method="post" action="${pageContext.request.contextPath}/login">
			<table id="login" class="table-borderless">
				<tr>

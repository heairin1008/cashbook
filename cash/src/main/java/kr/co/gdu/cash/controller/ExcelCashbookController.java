...
@Scope("prototype") // 컴포넌트타입의 scope의 디폴트값은 singleton
class CashbookExcelView extends AbstractXlsView{
	@Autowired CashbookService cashbookSerivce;
	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		response.setHeader("Content-Disposition", "attachment; file=\"cashbook.xls\"");
		List<Cashbook> cashbookList = cashbookSerivce.getCashbookListAll();
